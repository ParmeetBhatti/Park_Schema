...
<body>
<noscript>
    <div style="text-align: center; padding: 20px; background-color: #ffcccc; color: #333;">
...
if($conn->connect_error){
    ...
    if ($data && $data['password'] == $hashedPassword) {
        ...
        if($Yj == $Yi_db && $Zj == $Zi_db){
            echo "<b><h2 style='color: green;'><br><br><center>Generate OTP</center></h2></b>";
            
            $recipientEmail = $data['email'];
            echo "<center><button onclick='generateOTP()'>Send OTP</button></center>";
